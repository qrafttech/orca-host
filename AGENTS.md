...
| File | Covers |
|---|---|
| [architecture.md](.claude/knowledge/architecture.md) | image, entrypoint, CI, stack, VM and Ignition, network, data disk, restart vs rebuild, pairing, GitHub token, workspace trust |
